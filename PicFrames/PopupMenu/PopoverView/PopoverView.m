...
#define kGradientBottomColor [UIColor grayColor]

//top color white value in gradient bg
//#define kGradientTopColor [UIColor colorWithRed:0.02f green:0.02f blue:0.02f alpha:kBoxAlpha]
 #define kGradientTopColor [UIColor darkGrayColor]
