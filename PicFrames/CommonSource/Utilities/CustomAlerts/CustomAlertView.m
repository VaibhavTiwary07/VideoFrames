...
- (IBAction)dismiss:(id)sender
{
    ...
    if (sender == self || [sender tag] == CustomAlertViewButtonTagOk)
        [delegate CustomAlertView:self wasDismissedWithUserName:userField.text passward:inputField.text];
    else
    {
...
{
    if(nil != [delegate getTwitterUser])
    {
        self.userField.text = [delegate getTwitterUser];
        self.inputField.text = [delegate getTwitterPassword];
    }
    else
    {
