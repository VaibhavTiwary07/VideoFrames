...
- (id)init {
  ...
  if (self) {
    ...
    UIImage* iconImage = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle]pathForResource:@"FBDialog.bundle/images/fbicon" ofType:@"png"]];
    UIImage* closeImage = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle]pathForResource:@"FBDialog.bundle/images/close" ofType:@"png"]];
