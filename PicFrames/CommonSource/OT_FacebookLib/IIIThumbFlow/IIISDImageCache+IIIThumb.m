...
+ (IIISDImageCache *)sharedThumbImageCache
{
    if (thumbInstance == nil)
    {
        ...
        thumbInstance = [[IIISDImageCache alloc] initWithBasePath:basePath cacheAge:thumbMaxAge];
    }
...
- (id)initWithBasePath:(NSString *)path cacheAge:(NSInteger)age
{
    if ((self = [super init]))
    {
        [IIISDImageCache setMaxCacheAge:age];
