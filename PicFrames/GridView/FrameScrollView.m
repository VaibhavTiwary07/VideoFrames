...
//    [[SRSubscriptionModel shareKit]CheckingExpiryHere];
    ...
    if (self)
    {
        ...
        //check for 14 onwards//
        if (@available(iOS 14, *)) {
            
            pgControl = [[UIPageControl alloc]initWithFrame:CGRectMake(0,frame.size.height - FSV_PAGECONTROL_HEIGHT,250,FSV_PAGECONTROL_HEIGHT)];
            NSLog(@"ios 14 device");
            
        }
        else
        {
            pgControl = [[UIPageControl alloc]initWithFrame:CGRectMake(0,frame.size.height - FSV_PAGECONTROL_HEIGHT,FSV_PAGECONTROL_HEIGHT,FSV_PAGECONTROL_HEIGHT)];
        }
       ...
       // pgControl.pageIndicatorTintColor = [UIColor greenColor];
       // pgControl.currentPageIndicatorTintColor = [UIColor yellowColor];    //newlyadded
...
//page control here add
-(UIPageControl*)pageControlView
{
    UIPageControl *pView = (UIPageControl*)[self viewWithTag:FSV_TAG_PAGECONTROLVIEW];
    
//    pView.pageIndicatorTintColor = [UIColor greenColor];
//    pView.currentPageIndicatorTintColor = [UIColor yellowColor];    //newlyadded
    
    //pView.backgroundColor = [UIColor magentaColor];
...
//    pgControl.pageIndicatorTintColor = [UIColor greenColor];
//    pgControl.currentPageIndicatorTintColor = [UIColor yellowColor]; //newly
    
    //pgControl.backgroundColor = [UIColor magentaColor];
