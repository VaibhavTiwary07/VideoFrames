...
static NSDate *lastVersionCheckPerformedOnDate = nil;
...
+ (void)checkVersion
{
    NSLog(@"CheckVersion: checkVersion ---------");
    ...
    {
        NSLog(@"CheckVersion: Received Response");
        if ( [data length] > 0 && !error )
        { // Success
            NSLog(@"CheckVersion: Success");
            NSDictionary *appData = [NSJSONSerialization JSONObjectWithData:data options:NSJSONReadingAllowFragments error:nil];
            
            dispatch_async(dispatch_get_main_queue(), ^{
                NSLog(@"CheckVersion: Main queue");
                
                [[NSUserDefaults standardUserDefaults]setObject:[NSDate date] forKey:@"Harpy_lastversioncheckdate"];
                ...
                { // No versions of app in AppStore
                    NSLog(@"checkVersion:No version of he app in Appstore");
                    return;
                ...
                else
                {
                    ...
                    NSLog(@"checkVersion:Current Appstore version is %@",currentAppStoreVersion);
                    ...
                    {
                        NSLog(@"checkVersion:Current installed version is the newest public version");
...
+ (void)checkVersionDaily
{
     ...
     */
    lastVersionCheckPerformedOnDate = [[NSUserDefaults standardUserDefaults]objectForKey:@"Harpy_lastversioncheckdate"];
    
    if ( !lastVersionCheckPerformedOnDate ) {
        
        NSLog(@"checkVersionDaily:Setting initial date");
        [[NSUserDefaults standardUserDefaults]setObject:[NSDate date] forKey:@"Harpy_lastversioncheckdate"];
        // Set Initial Date
        lastVersionCheckPerformedOnDate = [NSDate date];
    ...
    {
        NSLog(@"checkVersionDaily:lastVersionCheckPerformedOnDate is not nil");
    }
