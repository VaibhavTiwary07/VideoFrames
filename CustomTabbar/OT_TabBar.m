...
-(void)setItems:(NSArray *)items
{
    ...
    for(index = 0; index < [items count];index++)
    {
        ...
        //bottom1//
        _itemslabel = [[UILabel alloc] initWithFrame:CGRectMake(x, y+buttonHeight-25, buttonWidth, 20)];
        _itemslabel.text = [itemTitleArray objectAtIndex:index];
        _itemslabel.textColor=[UIColor whiteColor];
        _itemslabel.textAlignment=NSTextAlignmentCenter;
        if (UIUserInterfaceIdiomPad == [UIDevice currentDevice].userInterfaceIdiom)
        {
            //_itemslabel.font = [UIFont systemFontOfSize:10.0f];
            _itemslabel.font = [UIFont fontWithName:@"Gilroy-Medium" size:12.0f];
        }
        else
            
            //_itemslabel.font = [UIFont systemFontOfSize:8.0f];
            _itemslabel.font = [UIFont fontWithName:@"Gilroy-Medium" size:10.0f];
...
//    [_items release];
//    [delegate release];
//    [itemTitleArray release];
//    [selectedTabOverlayColor release];
//    [selectedTabOverlayImage release];
//    [super dealloc];
//    
//}
@end
