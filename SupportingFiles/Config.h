...
#define PHOTO_DEFAULT_COLOR_R (0.0f)
#define PHOTO_DEFAULT_COLOR_G (0.0f)
#define PHOTO_DEFAULT_COLOR_B (0.0f)
...
// Black background for all screens
#define DARK_GRAY_BG [UIColor colorWithRed:0 green:0 blue:0 alpha:1]
